...
const Search = ({statuses}: SearchProps) => {
    ...
    return ( 
        <div className="flex flex-col gap-2">
                    <input className="rounded-lg w-full border border-solid border-cyan-600  focus:outline focus:outline-cyan-600 focus:outline-3 h-8 col-span-5 row-span-1 pl-2 text-sm"  value={searchparams.get('query')?.toString() || ''} onChange={handleChangeTextSearch}/>
